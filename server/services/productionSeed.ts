  ...
  try {
    ...
    await db.transaction(async (tx) => {
      ...
      const usersData = [
        ...
        { id: '48003611', email: 'txpsinvestigations@gmail.com', firstName: 'Brigido', lastName: 'Guillen', passwordHash: '$2b$10$r3GT8OdoCwxosnHVWfQmFeMRnvv1BOhJIKA5BjWQ3g2eG3LQ4ko0K', role: 'user', emailVerified: false, currentWorkspaceId: '37a04d24-51bd-4856-9faa-d26a2fe82094' },
