...
uter.get('/invites', async (req: AuthenticatedRequest, res) => {
  try {
...
outer.post('/invite/:id/revoke', async (req: AuthenticatedRequest, res) => {
  try {
    const workspaceId = req.workspaceId!;
    const { id } = req.params;
...
outer.get('/invites/status/:status', async (req: AuthenticatedRequest, res) => {
  try {
    const workspaceId = req.workspaceId!;
...
outer.post('/application', async (req, res) => {
  try {
...
outer.patch('/application/:id', async (req, res) => {
  try {
    const { id } = req.params;
...
outer.post('/signatures', async (req, res) => {
  try {
...
outer.post('/certifications', async (req, res) => {
  try {
...
outer.post('/documents/upload-url', async (req, res) => {
  try {
...
outer.get('/documents/:applicationId', async (req, res) => {
  try {
...
outer.post('/contracts/:contractId/sign', async (req, res) => {
  try {
...
er.post('/test-workflow', async (req, res) => {
  try {
    const user = req.user;
...
uter.get('/pending-review', async (req: AuthenticatedRequest, res) => {
  try {
    const workspaceId = req.workspaceId!;
...
outer.get('/readiness', async (req: AuthenticatedRequest, res) => {
  try {
    const workspaceId = req.workspaceId;
