...
export const ORG_STATUS_MESSAGES_CONFIG: Record<OrgStatusType, OrgStatusMessage> = {
  ...
  trial_ending: {
    ...
    description: "Your {daysRemaining}-day trial expires on {trialEndDate}. Upgrade now to continue using AutoForce™.",
  ...
  trial_expired: {
    ...
    severity: "error",
    title: "Trial Expired",
    description: "Your trial period has ended. Subscribe to a plan to continue using AutoForce™.",
