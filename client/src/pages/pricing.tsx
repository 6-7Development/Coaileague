...
export default function Pricing() {
  const tiers: PricingTier[] = [
    ...
    },
    {
      ...
      roi: "66x ROI",
      description: "Complete AI-powered automation for growing businesses",
      cta: "Start Free Trial",
      popular: true,
      features: [
        ...
        { name: "AI Token Usage: $50/month included", included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { name: "Priority 24/7 Phone & Chat Support", included: true },
        { name: "API Access & Custom Webhooks", included: true },
        { name: "Custom Integration Assistance", included: true },
        { name: "AI Token Usage: $200/month included", included: true },
